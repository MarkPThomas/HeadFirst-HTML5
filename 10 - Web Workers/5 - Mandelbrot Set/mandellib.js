...
function createTask(row) {
    var task = {
        ...
        generation: generation, // Identifies how many times we’ve zoomed in.

        // These define the area of the Mandelbrot we’re computing
        r_min: r_min,
        r_max: r_max,
        i: i_max + (i_min - i_max) * row / canvas.height,

        // And these control the precision of what we’re computing.
        max_iter: max_iter,
        escape: escape
    };
    return task;
